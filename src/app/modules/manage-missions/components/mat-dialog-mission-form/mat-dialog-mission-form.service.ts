...
export class MatDialogMissionFormService {
  ...
  public createMissionForm(data?: any): FormGroup {
    ...
    // const aDate = new Date(+dayStart, +monthStart - 1, +yearStart);
    ...
    if (data) {
      return this.formBuilder.group({
        ...
        [MatDialogMissionFormControlsName.MISSION_DATE]: this.formBuilder.control(formatDate(aDate, 'yyyy-MM-dd', 'en'), {
